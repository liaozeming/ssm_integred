                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a href="layouts-normal.html" class="nav-link">
                                    <i class="icon icon-target"></i> 用户表
                                </a>
                            </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="${pageContext.request.contextPath }/SaveUser.action" method="post" id="SveUserForm">
                                <table class="table">
                                    <thead>
                                    <tr>
                                        <th>姓名</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="${pageContext.request.contextPath }/DeleteUser.action?id=${user.id}" class="nav-link"/>删除</td>
                                            <td><a type="submit" class="nav-link"/>保存</td>
